...
from user.models import DnFinvasiaUserCredsMaster, DnBrokerUserCredsMaster
import threading
...
@shared_task()
def place_order_by_Finvasia_master_task(broker_creds_obj, master_id):
    accounts = [
        {
    ...
    master = DnFinvasiaUserCredsMaster.objects.get(id=master_id)
    master.is_background_task_running = False
    master.save()
